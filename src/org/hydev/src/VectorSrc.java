...
public class VectorSrc<E>
     ...
     *                                  is negative
     */
    public VectorSrc(int initialCapacity, int capacityIncrement) {
        super();
